// Ported from epub_pro (https://github.com/watate/epub_pro), lib/src/cfi/ — MIT License.
...
class XMLDOMNode extends DOMNode {
  ...
  String? get id {
    if (_xmlNode is XmlElement) {
      return (_xmlNode).getAttribute('id');
    }
    return null;
  }
  ...
  String? getAttribute(String name) {
    if (_xmlNode is XmlElement) {
      return (_xmlNode).getAttribute(name);
    }
    return null;
  }
  ...
  void setAttribute(String name, String value) {
    if (_xmlNode is XmlElement) {
      (_xmlNode).setAttribute(name, value);
    }
  }
  ...
  String get innerHTML {
    if (_xmlNode is XmlElement) {
      return (_xmlNode).children.map((e) => e.toString()).join();
    }
    return '';
  }
...
class XMLDOMElement extends XMLDOMNode implements DOMElement {
  XMLDOMElement._(XmlElement super.xmlElement) : super._();
...
class XMLDOMText extends XMLDOMNode implements DOMText {
  XMLDOMText._(XmlText super.xmlText) : super._();
